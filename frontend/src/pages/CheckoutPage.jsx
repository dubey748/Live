...
const CheckoutPage = () => {
  ...
  const addresses = [
    {
      name: "ABhishek Dubey",
      street: "20th Cross Road",
      city: "Gorakhpur",
      pinCode: 273153,
      state: "UP",
      phone: 94534241,
      email: "live@dubey.com",
    },
    {
      name: " Dubey",
      street: "7th Cross Road",
      city: "Farenda",
      pinCode: 273155,
      state: "Uttar Pradesh",
      phone: 79879063,
      email: "dubey@live.com",
    },
  ];
  return (
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list">
                  {addresses.map((address) => (
                    <li
                      key={address.email}
                      className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-grey-200"
                    >
